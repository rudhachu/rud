    ...
    if (config.SESSION_ID) {
      ...
      try {
        file.download((error, content) => {
          if (error) {
            console.error("Error downloading the session file:", error);
            throw error;
          }

          // Ensure the session directory exists before writing the file
      ...
      console.error("SESSION_ID is not defined in the configuration.");
    }
  } else {
    console.log("Session file already exists. Proceeding...");
  }
